...
public class PublicGroupsActivity extends BaseActivity {
    ...
    private void setSeachChangedListener() {
                ...
                if (scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
                    if (listView.getCount() != 0) {
                        ...
                        if (hasMoreData && !isLoading && lasPos == listView.getCount() - 1) {
                            pageId++;
                            new DownloadPublicGroupTask(PublicGroupsActivity.this, SuperWeChatApplication.getInstance().getUserName(), pageId, pagesize).execute();
                            loadAndShowData();
                        }
                    }
                }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("error", "publicGroups list" + publicGroupList + publicGroupList.size());
...
//                    });
     ...
     *
     */
    public static class GroupsAdapter extends BaseAdapter implements SectionIndexer {
        static final String TAG = PublicGroupsActivity.class.getName();
        List<String> list;
        Context mContext;
