...
//    }
    ...
    private Response.Listener<Message> responseSetCollectListener() {
        return new Response.Listener<Message>() {
            @Override
            public void onResponse(Message messageBean) {
                if (messageBean.isResult()) {
    ...
    private void initColorsBanner() {
        ...
        for (int i = 0; i < mGoodDetails.getProperties().length; i++) {
            ...
            Log.e(TAG, "initColorsBanner.goodDetails=" + mGoodDetails.getProperties()[i].toString());
    ...
    private Response.Listener<Message> responseIsCollectListener() {
        return new Response.Listener<Message>() {
            @Override
            public void onResponse(Message messageBean) {
                if (messageBean.isResult()) {
